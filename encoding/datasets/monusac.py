...
def _get_cityscapes_pairs(folder, split='train'):
    ...
    if split == 'train':
        split_f = os.path.join('datasets/monusac', 'train_fine.txt')
        img_paths, mask_paths = get_path_pairs(folder, split_f)
    elif split == 'val':
        split_f = os.path.join('datasets/monusac', 'val_fine.txt')
        img_paths, mask_paths = get_path_pairs(folder, split_f)
    elif split == 'test':
        split_f = os.path.join('datasets/monusac', 'val_fine.txt')
        img_paths, mask_paths = get_path_pairs(folder, split_f)
    else:
        split_f = os.path.join('datasets/monusac', 'trainval_fine.txt')
        img_paths, mask_paths = get_path_pairs(folder, split_f)
