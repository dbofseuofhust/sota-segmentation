...
class Trainer():
    def __init__(self, args):
        ...
        if args.warmup:
            ...
            self.scheduler = utils.WarmupMultiStepLR(self.optimizer, [int(v) for v in args.mutil_steps.split(',')], args.gamma, args.warmup_factor, args.warmup_epoch, args.warmup_method)
        else:
